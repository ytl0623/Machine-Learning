...
def PocketAlgorithm (x_coor, y_coor, label, Fixpoint_x_coor, Fixpoint_y_coor, centerOfx_coor, centerOfy_coor):
...
if __name__ == '__main__':
    ...
    misclassifiedLenght = len(misclassifiedList) 
    splitSlope = normalSlope
    baseSplitSlope = splitSlope
    iteration = 1
    ...
    while len(misclassifiedList) != 0:
        ...
        misclassifiedList, splitSlope = PocketAlgorithm(x_coor, y_coor, label, Fixpoint_x_coor, 
                                                        Fixpoint_y_coor, centerOfx_coor, centerOfy_coor)

        # if classification result is better than the previous iteration , being updated
        if len(misclassifiedList) < misclassifiedLenght:
            misclassifiedLenght = len(misclassifiedList)
            baseSplitSlope = splitSlope
    ...
    b_constant = centerOfy_coor - baseSplitSlope * centerOfx_coor
    
    y = baseSplitSlope * x + b_constant
